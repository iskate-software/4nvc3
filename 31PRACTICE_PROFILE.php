...
<form name="line-item" method="get" action="PRACTICE_PROFILE_RESULTS.php" >
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#446441" frame="void" rules="cols">
          <tr>
            ...
            <td width="100%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="35" colspan="2" align="center" valign="middle" class="Verdana12"><strong><u>PRACTICE PROFILE</u></strong></td>
              </tr>
              <tr>
