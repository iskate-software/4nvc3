...
<table width="732" height="553" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><!--DWLayoutTable-->
  <tr>
    ...
    <td width="294" align="center" valign="bottom" class="Verdana13B">PST RATE UPDATE</td>
    <td width="219">&nbsp;</td>
  </tr>
  <tr>
    <td height="337">&nbsp;</td>
	...
	<div id="shadowedtable">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td width="93" height="20" align="left">&nbsp;</td>
        </tr>
        <tr>
          <td height="20" align="right" class="Labels2">Enter the new taxrate</td>
          <td height="20" align="left"><span class="Labels">
            <input name="" type="text" class="Inputright" id="b" onfocus="InputOnFocus(this.id)" onblur="InputOnBlur(this.id)" value="8.00" size="5" maxlength="5"/>
          </span></td>
        </tr>
        <tr>
