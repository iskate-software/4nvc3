...
<title>CHANGE DISPENSING FEE BY CLASS</title>
<!-- InstanceEndEditable -->
...
<form action="" class="FormDisplay" method="post">
  <table width="732" height="553" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td width="294" align="center" valign="bottom" class="Verdana13B">CHANGE DISPENSING FEE BY CLASS</td>
      <td width="219">&nbsp;</td>
    </tr>
    <tr>
      <td height="337">&nbsp;</td>
      ...
      <div id="shadow">
        <div id="shadowedtable">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td width="41" align="left" class="Labels2">&nbsp;</td>
              <td width="269" height="20" colspan="2" align="left" class="Labels2">Enter price class<span class="Labels">
                <input name="b2" type="text" class="Input" id="b2" onfocus="InputOnFocus(this.id)" onblur="InputOnBlur(this.id)" size="3" maxlength="2"/>
              </span></td>
              </tr>
            <tr>
              <td height="20" align="left" class="Labels2">&nbsp;</td>
              <td height="20" colspan="2" align="left" class="Labels2">Enter the new dispensing fee<span class="Labels">
