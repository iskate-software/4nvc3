...
// Set up the flag for navigating to the next screen.
if ($_SESSION['narcotic'] == 'SHIP') {$where = 'NARCOTIC_SHIPMENT_DETAIL' ;} else {$where = '../../PATIENT/CLINICAL_LOGS/CREATE_NARCOTIC_LOG' ;}
