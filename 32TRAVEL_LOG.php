...
<form name="travel_log" method="get" action="TRAVEL_LOG_RESULTS.php" >
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                &nbsp;&nbsp;&nbsp;
                <label>&nbsp;
                  <input type="radio" name="file2search" id="radio2" value="DVMILAST" onchange="document.travel_log.startdate.value='';document.travel_log.enddate.value='';"/>
              ...
              <tr>
                ...
                &nbsp;&nbsp;&nbsp;
                <label>&nbsp;
                  <input type="radio" name="file2search" id="radio3" value="ARYDVMI" onchange="document.travel_log.startdate.value='';document.travel_log.enddate.value='';"/>
            ...
            <td width="54%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="25" colspan="2" align="center" class="Verdana12"><input type="button" name="button" id="button" value="Clear Dates" onclick="document.travel_log.startdate.value='';document.travel_log.enddate.value='';" /></td>
              </tr>
              <tr>
