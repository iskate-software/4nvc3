...
<form action="ORDERS_REPORT_RESULTS.php" class="FormDisplay" method="post">
      ...
      <div id="shadow">
        <div id="shadowedtable">
          <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="18" align="right" valign="middle" class="Verdana12">&nbsp;</td>
            ...
            <tr align="center" valign="bottom" class="Labels">
              <td height="17" colspan="2" align="right" valign="middle" class="Verdana12">Which Location?</td>
              <td width="12" height="17" align="center" valign="middle" class="Verdana12"></td>
              <td width="138" height="17" align="left" valign="middle" class="Verdana12"><input name="b" type="text" class="Input" id="b" size="6" maxlength="36" onfocus="InputOnFocus(this.id)" onblur="InputOnBlur(this.id)"/></td>
            </tr>
            
            <tr>
              <td height="33" colspan="4" align="center" valign="top" class="Labels2">(Blanks give all)</td>
            </tr>
            <tr>
              <td width="81" height="20" align="right"><input type="checkbox" name="checkbox3" id="checkbox3" /></td>
              <td height="20" colspan="3" align="left" class="Labels">Create Own Print List </td>
            </tr>
            <tr>
              <td height="20" colspan="4" align="center"><select name="select" id="select">
            ...
            <tr>
              <td colspan="4" align="center" valign="middle" class="ButtonsTable">
