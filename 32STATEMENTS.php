...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr align="center">
    ...
    <table width="660" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" frame="box" rules="none">
      ...
      <tr>
        <td height="55" align="center" class="Verdana12">Enter the last date of the statement accouting period:<br />
      ...
      <tr>
        ...
        <td class="Verdana12"><input name="balfwddate" type="text" class="Input" id="balfwddate" size="10" maxlength="10" onclick="ds_sh(this);" onfocus="InputOnFocus(this.id)" onblur="InputOnBlur(this.id)" value="<?php echo date('m/d/Y'); ?>" title="MM/DD/YYYY"/></td>
      </tr>
    </table></td>
  </tr>
  <tr align="center">
    ...
    <table width="660" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" frame="box" rules="none">
      ...
      <tr>
        ...
        <td height="40" align="left" class="Verdana12"><label>
          <input type="checkbox" name="indivclient" id="indivclient" value="1"/>
  ...
  <tr align="center">
        ...
        <table width="660" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" frame="box" rules="none">
          ...
          <tr>
            ...
            <td width="153" class="Verdana12"><input name="startname" type="text" class="Input" id="startname" size="15" maxlength="15" value = "<?php echo '               ' ; ?>" onfocus="InputOnFocus(this.id)" onblur="InputOnBlur(this.id)" /></td>
            <td colspan="2" class="Verdana11Grey">Blank will start at the beginning</td>
          </tr>
          <tr>
            <td class="Verdana12">&nbsp;</td>
            <td height="30" class="Verdana12">Ending Name</td>
            <td class="Verdana12"><input name="endname" type="text" class="Input" id="endname" size="15" maxlength="15" value = "<?php echo '               ' ; ?>"  onfocus="InputOnFocus(this.id)" onblur="InputOnBlur(this.id)" /></td>
