...
<form action="CLIENT_BALANCE_RESULTS.php" name="client_balance-results" method="get" >
<table width="100%" height="590" border="0" cellpadding="0" cellspacing="0">
  <tr align="center">
    ...
    <table width="660" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" frame="box" rules="none">
      <tr>
        <td height="37" colspan="2" align="center" class="Verdana13B">DEFINE THE CLIENT BALANCE REPORT GUIDELINES</td>
        </tr>
      <tr>
        <td height="55" align="center" class="Verdana12">Enter the last date of the accounting period:<br />
          <span class="Verdana11Grey">(Cash Receipts and Invoices after this date will be ignored.)</span></td>
        <td width="180" class="Verdana12"><input name="startdate" type="text" class="Input" id="startdate" size="10" maxlength="10" onclick="ds_sh(this);" onfocus="InputOnFocus(this.id)" onblur="InputOnBlur(this.id)" value="<?php echo date('m/d/Y'); ?>"/></td>
      </tr>
    </table></td>
  </tr>
...
<!---<input name="startdate" type="hidden" value="<?php echo $_POST['startdate']; ?>" />
