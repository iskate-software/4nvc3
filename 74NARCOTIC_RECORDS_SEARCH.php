...
<form action="RESULTS_NARCOTIC_RECORDS.php" class="FormDisplay" method="post">
	  ...
	  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#446441" frame="void" rules="cols">
        <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="center" class="Verdana12"><strong><u>WHICH NARCOTIC</u></strong></td>
            </tr>
            <tr>
              <td align="center" class="Labels2">(Blanks for all)</td>
            </tr>
            <tr>
              <td height="30" align="center"><input name="item" id="item" type="text" class="Input" size="6" onfocus="InputOnFocus(this.id)" onblur="InputOnBlur(this.id)"/>
              </td>
            </tr>
          </table></td>
          <td width="54%">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td align="center" class="Labels2">MM/DD/YYYY</td>
            </tr>
            <tr>
              <td align="right" class="Labels">Starting Date</td>
              <td align="center"><input name="a" id="a" type="text" class="Input" size="10" onfocus="InputOnFocus(this.id)" onblur="InputOnBlur(this.id)"/></td>
            </tr>
            <tr>
              <td align="right" class="Labels">Ending Date</td>
              <td align="center"><input name="b" id="b" type="text" class="Input" size="10" onfocus="InputOnFocus(this.id)" onblur="InputOnBlur(this.id)"/></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
