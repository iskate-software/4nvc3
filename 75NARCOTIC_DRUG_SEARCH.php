...
<form name="drugs" action="NARCOTIC_SEARCH_SCREEN.php" target="_top" class="FormDisplay">
<table width="100%" height="515" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <table width="418" height="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#446441" frame="border" rules="none">
      <tr>
        <td width="247" align="center" class="Verdana12">Please enter narcotic drug code</td>
        <td width="165" align="center" valign="middle"><input name="item" type="text" class="Input" id="item" size="8" maxlength="8" onfocus="InputOnFocus(this.id)" onblur="InputOnBlur(this.id)" /></td>
      </tr>
    </table>
  ...
  <tr class="ButtonsTable">
	...
	<input name="view" type="submit" class="button" value="SCAN" />
    <input name="cancel" type="reset" class="button" value="CANCEL" onclick="history.back()" />    </td>
    </tr>
</table>
</form>
