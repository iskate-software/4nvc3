...
<title>Rank Clients By Expenditure</title>
<!-- InstanceEndEditable -->
...
<form name="line-item" method="get" action="RANK_CLIENTS_RESULTS.php" >
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#446441" frame="void" rules="cols">
          <tr>
            ...
            <td width="100%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="35" colspan="2" align="center" valign="middle" class="Verdana12"><strong><u>DATES TO INCLUDE</u></strong></td>
              </tr>
              <tr>
             ...
             <?php for ($key=0; $key<$numdocs; $key++) { 
              ...
              <tr>
                ...
                <label>
                Minimum Expenditure:&nbsp;
                <input name="company" type="text" class="Input" id="company" size="10" maxlength="50" onfocus="InputOnFocus(this.id)" onblur="InputOnBlur(this.id)" value=""/>
                </label>&nbsp;&nbsp;&nbsp;&nbsp;<br />
                </td>
              </tr>
