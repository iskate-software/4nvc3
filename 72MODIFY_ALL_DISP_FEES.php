...
<title>MODIFY ALL DISPENSING FEES</title>
<!-- InstanceEndEditable -->
...
<table width="732" height="553" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><!--DWLayoutTable-->
  <tr>
    ...
    <td width="294" align="center" valign="bottom" class="Verdana13B">MODIFY ALL DISPENSING FEES</td>
    <td width="219">&nbsp;</td>
  </tr>
  <tr>
    <td height="337">&nbsp;</td>
	...
	<div id="shadowedtable">
	  <table width="330" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td height="25" colspan="5" align="left" class="Labels2">Enter amount by which to modify all</td>
          </tr>
        <tr>
          <td height="25" align="left" class="Labels2">&nbsp;</td>
          <td height="25" colspan="4" align="left" valign="middle" class="Labels2">non-zero dispensing fees</td>
          <td height="25" align="left" valign="middle" class="Labels2"><span class="Labels">
            <input name="b" type="text" class="Inputright" id="b" onfocus="InputOnFocus(this.id)" onblur="InputOnBlur(this.id)" value="0.00" size="6" maxlength="6"/>
          </span></td>
        </tr>
        <tr>
          <td height="34" align="right" valign="middle" class="Labels2">&nbsp;</td>
          <td width="66" align="right" valign="middle"><input type="radio" name="radio" id="a" value="a" /></td>
          <td width="39" align="left" valign="middle" class="Labels2">Add</td>
          <td align="right" valign="middle"><input type="radio" name="radio" id="a2" value="a" /></td>
          <td colspan="2" align="left" valign="middle" class="Labels2">Substract</td>
          </tr>
        <tr>
          <td align="right">&nbsp;</td>
          <td colspan="2" align="right">&nbsp;</td>
