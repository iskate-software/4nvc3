...
$get_yrago = mysqli_query($tryconnection, $yearago) or die(mysqli_error($mysqli_link)) ;
$row_lastyear = mysqli_fetch_array($get_yrago) ;
$lastyear = $row_lastyear['LASTYR'] ;

$yearagoday = "SELECT DAY('$lastyear') AS DDATE" ;
$get_yragoday = mysqli_query($tryconnection, $yearagoday) or die(mysqli_error($mysqli_link)) ;
$row_lastyeard = mysqli_fetch_array($get_yragoday) ;
...
$get_yrago1 = mysqli_query($tryconnection, $yearago1) or die(mysqli_error($mysqli_link)) ;
$row_lastyeard1 = mysqli_fetch_array($get_yrago1) ;
$period_begin = $row_lastyeard1['LASTBEG'] ;
echo ' last year '.$lastyeard . ' beginning ' . $period_begin  ;
$get_inv1 = mysqli_query($tryconnection, $getinv1) or die(mysqli_error($mysqli_link)) ;
$get_inv2 = mysqli_query($tryconnection, $getinv2) or die(mysqli_error($mysqli_link)) ;
$get_cash1 = mysqli_query($tryconnection, $getcash1) or die(mysqli_error($mysqli_link)) ;
$get_cash2 = mysqli_query($tryconnection, $getcash2) or die(mysqli_error($mysqli_link)) ;
$get_tax = mysqli_query($tryconnection, $gettax) or die(mysqli_error($mysqli_link)) ;
$get_ar = mysqli_query($tryconnection, $getar) or die(mysqli_error($mysqli_link)) ;
$get_cred = mysqli_query($tryconnection, $getcred) or die(mysqli_error($mysqli_link)) ;
$get_year = mysqli_query($tryconnection, $getyear) or die(mysqli_error($mysqli_link)) ;
$get_month = mysqli_query($tryconnection, $getmonth) or die(mysqli_error($mysqli_link)) ;
//echo ' did second      etc ' ;
$row_inv1 = mysqli_fetch_array($get_inv1) ;
$row_inv2 = mysqli_fetch_array($get_inv2) ;
$row_cash1 = mysqli_fetch_array($get_cash1) ;
$row_cash2 = mysqli_fetch_array($get_cash2) ;
$row_tax = mysqli_fetch_array($get_tax) ;
$row_ar = mysqli_fetch_array($get_ar) ;
$row_cred = mysqli_fetch_array($get_cred) ;
$totcash = $row_cash1['CASH1'] + $row_cash2['CASH2'] ;
$totar = $row_ar['AR1'] - $row_cred['AR2'] ;
$row_thisyear = mysqli_fetch_array($get_year) ;
/*
...
$get_ytd1 = mysqli_query($tryconnection, $YTD_SALES1) or die(mysqli_error($mysqli_link))  ;
$get_ytd2 = mysqli_query($tryconnection, $YTD_SALES2) or die(mysqli_error($mysqli_link))  ;
$get_ycash1 = mysqli_query($tryconnection, $YTD_CASH1) or die(mysqli_error($mysqli_link))  ;
$get_ycash2 = mysqli_query($tryconnection, $YTD_CASH2) or die(mysqli_error($mysqli_link))  ;
$get_yhst = mysqli_query($tryconnection, $YTD_HST1) or die(mysqli_error($mysqli_link)) ;
$get_yinvn1 = mysqli_query($tryconnection, $YTD_SALESN1) or die(mysqli_error($mysqli_link)) ;
$get_yinvn2 = mysqli_query($tryconnection, $YTD_SALESN2) or die(mysqli_error($mysqli_link)) ;
$get_pastmi = mysqli_query($tryconnection, $LASTYMON_SALES) or die(mysqli_error($mysqli_link))  ;
$get_pastmc = mysqli_query($tryconnection, $LASTYMON_CASH) or die(mysqli_error($mysqli_link))  ;
$get_pytdi = mysqli_query($tryconnection, $PYTD_SALES) or die(mysqli_error($mysqli_link))  ;
$get_pytdc = mysqli_query($tryconnection, $PYTD_CASH) or die(mysqli_error($mysqli_link))  ;
$get_pymn1 = mysqli_query($tryconnection, $PYM_SALESN1) or die(mysql_erro()) ;
$get_pymn2 = mysqli_query($tryconnection, $PYM_SALESN2) or die(mysql_erro()) ;

$row_ytd1 = mysqli_fetch_array($get_ytd1) ;
$row_ytd2 = mysqli_fetch_array($get_ytd2) ;
$row_ycash1 = mysqli_fetch_array($get_ycash1) ;
$row_ycash2 = mysqli_fetch_array($get_ycash2) ;
$row_yhst = mysqli_fetch_array($get_yhst) ;
$row_yinvn1 = mysqli_fetch_array($get_yinvn1) ;
$row_yinvn2 = mysqli_fetch_array($get_yinvn2) ;
$row_pastmi = mysqli_fetch_array($get_pastmi) ;
$row_pastmc = mysqli_fetch_array($get_pastmc) ;
$row_pytdi = mysqli_fetch_array($get_pytdi) ;
$row_pytdc = mysqli_fetch_array($get_pytdc) ;
$row_pymn1 = mysqli_fetch_array($get_pymn1) ;
$row_pymn2 = mysqli_fetch_array($get_pymn2) ;
//echo ' now the past ' ;
