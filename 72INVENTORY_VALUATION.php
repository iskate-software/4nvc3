...
<table width="732" height="553" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"><!--DWLayoutTable-->
  <tr>
    ...
    <td width="294" align="center" valign="bottom" class="Verdana13B">INVENTORY VALUATION</td>
    <td width="219">&nbsp;</td>
  </tr>
  <tr>
    <td height="337">&nbsp;</td>
	...
	<div id="shadowedtable">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="58" colspan="2" align="center" class="Verdana12"><strong><u>SELECT TYPE OF INVENTORY CALCULATION</u></strong></td>
          </tr>
        <tr>
          <td width="56" height="25" align="right"><input type="radio" name="radio" id="a" value="a" /></td>
          <td width="294" height="25" align="left" class="Labels2">On Hand Quantity/Package Quantity * Cost</td>
        </tr>
        <tr>
          <td height="25" align="right"><input type="radio" name="radio" id="a2" value="a" /></td>
          <td height="25" align="left" class="Labels2">On Hand Quantity*Cost</td>
        </tr>
        <tr>
          <td align="right">&nbsp;</td>
          <td align="left">&nbsp;</td>
