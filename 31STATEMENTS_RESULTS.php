...
$search_ARINVOI="SELECT *, DATE_FORMAT(INVDTE, '%m/%d/%Y') AS INVDTE FROM $file2search WHERE INVDTE >= '$startdate[0]' AND INVDTE <= '$enddate[0]' ORDER BY INVNO ASC";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="15" colspan="4" align="center" valign="bottom" class="Verdana13BBlue">Invoice Register Summary</td>
    </tr>
  <tr>
    <td height="1"></td>
