...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr id="prthospname">
    <td colspan="10" height="30" align="center" class="Verdana13B"><script type="text/javascript">document.write(localStorage.hospname);</script>
    </td>
    </tr>
  <tr height="10" bgcolor="#000000" class="Verdana11Bwhite">
    <td width="9" align="left">&nbsp;&nbsp;Code</td>
    <td width="45" align="center">&nbsp;Description</td>
    <td width="6" align="left">&nbsp;DF.</td>
    <td width="7" align="left">Supplier&nbsp;</td>
    <td width="6" align="left">Cl.</td>
    <td width="8" align="center">Sup. Code</td>
    <td width="10" align="center">PkQty</td>
    <td width="10" align="center">Cost</td>
    <td width="10" align="center">Uprice</td>
    <td width="10" align="center">Pprice</td>
  </tr>
  <tr>
    <td colspan="10" class="Verdana12" align="center">
  ...
  <tr id="'.$row_INVENTORY['ITEMID'].'" onmouseover="highliteline(this.id)" onmouseout="whiteoutline(this.id)">
    ...
    <td class="Verdana12" align="right">'.$row_INVENTORY['DISPFEE'].'</td>
    <td class="Verdana12" align="center">&nbsp;'.$row_INVENTORY['SUPPLIER'].'</td>
