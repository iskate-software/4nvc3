...
<title>CHANGE SPECIFIC DISPENSING FEE</title>
<!-- InstanceEndEditable -->
...
<form action="" class="FormDisplay" method="post">
  <table width="732" height="553" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td width="294" align="center" valign="bottom" class="Verdana13B">CHANGE SPECIFIC DISPENSING FEE</td>
      <td width="219">&nbsp;</td>
    </tr>
    <tr>
      <td height="337">&nbsp;</td>
        ...
        <div id="shadowedtable">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="78" height="20" align="left">&nbsp;</td>
            </tr>
            <tr>
              <td height="20" align="right" class="Labels2">What is the dispensing fee to change?</td>
              <td height="20" align="left"><span class="Labels">
                <input name="b3" type="text" class="Inputright" id="b3" onfocus="InputOnFocus(this.id)" onblur="InputOnBlur(this.id)" value="0.00" size="5" maxlength="5"/>
              </span></td>
            </tr>
            <tr>
              <td height="20" align="right" class="Labels2">What is the new dispensing fee?</td>
              <td height="20" align="left"><span class="Labels">
                <input name="b" type="text" class="Inputright" id="b" onfocus="InputOnFocus(this.id)" onblur="InputOnBlur(this.id)" value="0.00" size="5" maxlength="5"/>
              </span></td>
            </tr>
            <tr>
