...
<title>REPORT BY LOCATION SEARCH</title>
...
<form method="get" action="REPORT_BY_LOCATION_RESULTS.php" name="location_search" target="mainWin" style="position:absolute; top:0px; left:0px; background-color:#FFFFFF;">
...
<table width="400" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="30" align="center" class="Verdana12">Location Code: 
      <input name="seq" type="text" class="Input" id="seq" size="6" onfocus="InputOnFocus(this.id)" onblur="InputOnBlur(this.id)"/></td>
    </tr>
  <tr>
