...
<title>NARCOTICS REGISTER</title>
<!-- InstanceEndEditable -->
...
<form name="narc_register" method="get" action="NARCOTICS_REGISTER_RESULTS.php" >
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#446441" frame="void" rules="cols">
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="35" align="center" valign="bottom" class="Verdana12"><strong><u>REPORTS REQUIRED</u></strong></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                &nbsp;&nbsp;&nbsp;
                <label>&nbsp;
                  <input type="radio" name="file2search" id="radio" value="All" checked="checked" />
                  All Narcotics</label></td>
              </tr>
              <tr>
                <td height="30" align="left" class="Verdana12">
                &nbsp;&nbsp;&nbsp;
                <label>&nbsp;
                  <input type="radio" name="file2search" id="radio2" value="Individual" onchange="document.narc_register.startdate.value='';document.narc_register.enddate.value='';"/>
                  Individual narcotic</label></td>
              </tr>
              <tr>
              <tr>
            ...
            <td width="54%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="25" colspan="2" align="center" class="Verdana12"><input type="button" name="button" id="button" value="Clear Dates" onclick="document.narc_register.startdate.value='';document.narc_register.enddate.value='';" /></td>
              </tr>
              <tr>
